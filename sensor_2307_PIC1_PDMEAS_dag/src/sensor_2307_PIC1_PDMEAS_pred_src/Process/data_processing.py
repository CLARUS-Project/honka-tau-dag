...
def process_core(df):
    ...
    x_data = df.drop(["2307_PIC1_PDMEAS",'2501_PIC1_PDMEAS', '2501_SIC1_PDMEAS', '2502_PIC1_PDMEAS', '2502_SIC1_PDMEAS', '2406_TIC1_PDMEAS'], axis=1)
    y_data = df['2307_PIC1_PDMEAS'].copy(deep=True)
