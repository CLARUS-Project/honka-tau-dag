...
def sensor_2406_FIC2_PDMEAS():
    ...
    init_container = k8s.V1Container(
        ...
        command=["sh", "-c", "mkdir -p /git && cd /git && git clone -b 2406_FIC2_PDMEAS --single-branch https://github.com/CLARUS-Project/honka-tau-dag.git"],
