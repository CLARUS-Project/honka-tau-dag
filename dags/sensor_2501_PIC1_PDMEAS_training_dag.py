...
@dag(
    ...
    catchup=False,
    tags=['integ', 'sensor_2501_PIC1_PDMEAS_pred'],
) 
def sensor_2501_PIC1_PDMEAS_training_dag():
    ...
    init_container = k8s.V1Container(
        ...
        command=["sh", "-c", "mkdir -p /git && cd /git && git clone -b sensor_2501_PIC1_PDMEAS --single-branch https://github.com/CLARUS-Project/honka-tau-dag"],
    ...
    def read_data_procces_task():
        ...
        sys.path.insert(1, '/git/honka-tau-dag/src/sensor_2501_PIC1_PDMEAS_pred_src')
...
# Call the DAG 
sensor_2501_PIC1_PDMEAS_training_dag()